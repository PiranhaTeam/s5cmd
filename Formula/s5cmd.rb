...
class S5cmd < Formula
  ...
  homepage "https://github.com/PiranhaTeam/s5cmd"

  # Source code archive. Each tagged release will have one
  url "https://github.com/PiranhaTeam/s5cmd/archive/v0.6.0.tar.gz"
  sha256 "70d89cc5f4d5c26aff6af716e3a6bb5d17bc084fa09c89312ac4eb69ae468a2a"
  head "https://github.com/PiranhaTeam/s5cmd"
  ...
  def install
    ...
    bin_path = buildpath/"src/github.com/PiranhaTeam/s5cmd"
    # Copy all files from their current location (GOPATH root)
    # to $GOPATH/src/github.com/PiranhaTeam/s3hash
